...
static const u4_t DEVADDR = 0x260CC063 ; // <-- Change this address for every node!
...
static const u1_t PROGMEM NWKSKEY[16] = { 0x2D, 0xD0, 0x72, 0x54, 0x75, 0x0D, 0x4E, 0xAF, 0x31, 0xF7, 0xAE, 0xB8, 0x4B, 0x5B, 0xC2, 0xC2 };
//static const u1_t PROGMEM DEVEUI[8] = {  07 00 B3 0D 50 7E 0D 00 };
static const u1_t PROGMEM APPSKEY[16] = { 0x19, 0xC8, 0x67, 0x86, 0xD8, 0xD6, 0xC5, 0x4F, 0xC4, 0x43, 0x89, 0x35, 0x74, 0x54, 0xA7, 0x47 };


void os_getArtEui (u1_t* buf) { memcpy_P(buf, NWKSKEY, 8); }
